...
class AdminProfileController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.index')->with('message', '投稿しました。');
    }
    ...
    public function post_update(Request $request){
        ...
        if ($updated) {
            return redirect()->route('admin.post_manage')->with('message', '投稿が更新されました。');
        } else {
            return redirect()->route('admin.post_manage')->with('message', '更新に失敗しました。');
        }
    }
    ...
    public function edit(Request $request)
    {
        ...
        return view('admin.post_form_edit', [
            'post_no' => $request->input('post_no'),
            'name' => $request->input('name'),
            'content' => $request->input('content'),
            'tags' => $request->input('tags')

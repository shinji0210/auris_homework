                ...
                <!-- 編集ボタン PUTとしてリクエストを送る-->
                  <form action="/tasks/<?php echo e($task->id); ?>" method="post" class="mt-10">
                      ...
                      <div class="flex flex-col items-center">
                          ...
                          <!-- inputタグのvalue属性の値は、TaskController.phpのeditメソッドから渡ってきた$task変数を使用して、 -->
                          <!-- 「task→name」とすることで、該当レコードのnameカラムの値を出力 -->
                              <input
...
unset($__errorArgs, $__bag); ?>
  ...
  </html><?php /**PATH /work/backend/resources/views/tasks/edit.blade.php ENDPATH**/ ?>
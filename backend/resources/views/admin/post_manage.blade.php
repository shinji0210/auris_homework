...
<body class="flex flex-col min-h-[100vh]">
    ...
    <div class="flex-col items-center bg-indigo-200 ">
        ...
        <div class="mt-2 items-center mx-auto max-w-4xl">
            <a href="{{ route('admin.index') }}" class="ml-4 inline-block px-6 py-1 bg-blue-600 text-white text-lg font-semibold rounded-md hover:bg-blue-700">
                ホームに戻る
            </a>
        </div>
        ...
        <script>
            document.getElementById('post_edit').addEventListener('click', function() {
                ...
                form.method = 'POST';
                form.action = '{{ route("admin.post_form_edit") }}';

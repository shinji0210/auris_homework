...
<body class="flex flex-col min-h-[100vh]">
    ...
    <header class="bg-gradient-to-r from-blue-500 to-cyan-500">
        <div class="max-w-7xl mx-auto px-2 sm:px-6">
            <div class="py-6">
                <p class="text-white text-3xl font-mochiy">shinjiの自己紹介ページ(管理用)</p>
            </div>
        </div>
    </header>
    ...
    <!-- 左側の説明部分 -->
        <div class="text-left text-gray-700 text-lg">
            ...
            <p class="text-base">
                ...
                ・ログアウトでログイン画面に戻ります。(再度ログインし直す必要があります。)
            </p>

            <div class="mt-2 items-center mx-auto max-w-4xl">
                <form action="{{ route('logout') }}" method="POST">
                    @csrf
                    <button type="submit" class="ml-0 inline-block px-2 py-1 bg-gray-500 text-white text-lg font-semibold rounded-md hover:bg-gray-700">
                        ログアウト
                    </button>
                </form>
            </div>
        ...
        <div class="flex flex-col space-y-0">
            ...
            <!-- 自己紹介へ向かう用のボタン -->
            <a href="{{ route('admin.self_introduction') }}" class="relative mt-0 ml-auto block w-40 h-14 text-white flex items-center text-2xl font-semibold bg-sky-700
            ...
            <!-- 経歴へ向かう用のボタン -->
            <a href="{{ route('admin.career') }}" class="relative mt-0 ml-auto block w-40 h-14 text-white flex items-center text-2xl font-semibold bg-sky-700
                border-2 border-green-200 transition-all duration-300 
                hover:bg-yellow-500 hover:border-black">
                　経歴
            </a>
            ...
            <!-- やりたいことへ向かう用のボタン -->
            <a href="{{ route('admin.want_to_do') }}" class="relative mt-0 ml-auto block w-40 h-14 text-white flex items-center text-2xl font-semibold bg-sky-700
                border-2 border-green-200 transition-all duration-300 
                hover:bg-yellow-500 hover:border-black">
                　やりたいこと
            </a>
            ...
            <!-- 特技へ向かう用のボタン -->
            <a href="{{ route('admin.skill') }}" class="relative mt-0 ml-auto block w-40 h-14 text-white flex items-center text-2xl font-semibold bg-sky-700
                border-2 border-green-200 transition-all duration-300 
                hover:bg-yellow-500 hover:border-black">
                　特技
            </a>
    ...
    <div class="flex-col items-center bg-orange-200 ">
        <div class="flex justify-between items-start p-4 bg-orange-200">
            <a href="{{ route('admin.post_form') }}" class="inline-block px-3 py-1 bg-orange-600 text-white text-lg font-semibold rounded-md hover:bg-orange-800">
                    投稿
            </a>
    ...
    <div id="passwordModal" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 hidden">
        ...
        <div class="bg-white p-6 rounded-lg shadow-lg">
            ...
            <form id="passwordForm" action="{{ route('admin.check_password') }}" method="POST">
                @csrf
                <!-- パスワード入力欄 -->
                <!-- プレースホルダーも設定 -->

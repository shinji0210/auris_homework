...
<body class="flex flex-col min-h-[100vh] bg-orange-100">
    <header class="bg-gradient-to-r from-blue-500 to-cyan-500">
        <div class="max-w-7xl mx-auto px-4 sm:px-6">
            <div class="py-6">
                <p class="text-white text-3xl font-mochiy">投稿フォーム(管理用)</p>
            </div>
        </div>
    </header>
    ...
    <div class="min-h-screen flex items-start justify-center p-6">
        <div class="text-left max-w-2xl mx-auto bg-white p-6 rounded-lg shadow-lg">
            ...
            <!-- ホームに戻るリンク -->
            <div class="mt-2">
                <a href="{{ route('admin.index') }}" id="home-link" class="inline-block px-6 py-1 bg-blue-600 text-white text-lg font-semibold rounded-md hover:bg-blue-700">
                    ホームに戻る
                </a>
            </div>
            <!-- スクリプト -->
